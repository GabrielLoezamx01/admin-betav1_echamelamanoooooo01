...
-- Volcando datos para la tabla echamelamano.category: 4 rows
...
INSERT INTO `clients` (`uuid`, `id`, `email`, `phone`, `andress`, `description`, `validate`, `id_category`, `photo`, `rang`, `active`, `name`, `last_name`) VALUES
	('wiqeujiwq', 1, 'test@gmailc.om', 'sin numero', 'dwdw', 'dwdwd', '1', '0', 'd', '0', 1, 'Jhon', 'Doe');
